        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex">
            {Array.from(Array(data?.difficult)!).map((_) => (
              <img src="/public/image/star_difficult.svg" className="w-6" />
            ))}
          </div>
        </div>
      </div>
